...
local function CreateItemDrop(index)
	...
	if Config.UseTarget then
		exports['lc-target']:AddTargetEntity(dropItem, {
			options = {
				{
...
CreateThread(function()
    if Config.UseTarget then
        exports['lc-target']:AddTargetModel(Config.VendingObjects, {
            options = {
                {
...
CreateThread(function()
    if Config.UseTarget then
        exports['lc-target']:AddTargetModel(Config.CraftingObject, {
            options = {
                {
