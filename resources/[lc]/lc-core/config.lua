...
QBConfig.UpdateInterval = 3 -- how often to update player data in minutes
...
QBConfig.Server.ClosedReason = "Server Kinni" -- Reason message to display when people can't join the server
...
QBConfig.Server.Discord = "https://discord.gg/aNTtwnGcAD" -- Discord invite link
