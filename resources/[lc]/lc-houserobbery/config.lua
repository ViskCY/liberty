...
Config.Rewards = {
    [1] = {
        ["cabin"] = {"diamond_ring", "goldchain", "cryptostick", "10kgoldchain", "rolex"},
        ["kitchen"] = {"sandwich", "water_bottle", "diamond_ring", "goldchain", "cryptostick", "10kgoldchain", "rolex"},
        ["chest"] = {"diamond_ring", "goldchain", "cryptostick", "10kgoldchain", "rolex", "weapon_combatpistol", "pistol_ammo"},
        ["livingroom"] = {"rolex", "diamond_ring", "goldchain", "cryptostick",}
    }
}
