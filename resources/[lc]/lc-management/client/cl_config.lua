...
Config.BossMenuZones = {
    ...
    ['mechanic'] = {
        { coords = vector3(-1427.62, -458.41, 35.91), length = 2.15, width = 2.6, heading = 300.0, minZ = 34.00, maxZ = 40.00 },
    },
}

Config.GangMenus = {
    ['lafieta'] = {
        vector3(-806.88, 167.25, 76.01),
    },
    ['ballas'] = {
        vector3(0,0, 0),
    },
...
Config.GangMenuZones = {
    ...
    ['lafieta'] = {
        { coords = vector3(-806.49, 166.68, 76.53), length = 1.5, width = 1.6, heading = 200.0, minZ = 70.0, maxZ = 80.0 },
    },

    ['hustlers'] = {
        { coords = vector3(-815.66, -194.15, 41.43), length = 1.5, width = 1.6, heading = 179.37, minZ = 40.0, maxZ = 43.0 },
    },

    ['aztecas'] = {
        { coords = vector3(-1156.7, -1517.24, 10.63), length = 1.5, width = 1.6, heading = 27.28, minZ = 10.0, maxZ = 13.0 },
    },
