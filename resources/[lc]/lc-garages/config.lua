...
Garages = {
    ...
    ['police'] = {
        ...
        vehicleCategories = {'emergency', 'car'},
        drawText = 'Parking',              --car, air, sea
        job = "police",
        debug = false,
        ['ParkingSpots'] = {
    ...
    ['pdgarage'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(463.69720458984, -999.49432373047),
            vector2(462.20321655273, -999.56988525391),
            vector2(462.12762451172, -998.75805664062),
            vector2(460.65084838867, -998.54443359375),
            vector2(459.86135864258, -1000.2873535156),
            vector2(442.53326416016, -1000.2854003906),
            vector2(442.37139892578, -999.24047851562),
            vector2(440.95425415039, -998.54504394531),
            vector2(440.33074951172, -1000.2854003906),
            vector2(426.65328979492, -1000.2827758789),
            vector2(426.52865600586, -998.68756103516),
            vector2(425.08984375, -998.54626464844),
            vector2(424.44281005859, -1000.2887573242),
            vector2(423.1760559082, -1000.2875976562),
            vector2(423.15319824219, -973.03857421875),
            vector2(424.44284057617, -973.03930664062),
            vector2(424.48498535156, -974.29156494141),
            vector2(426.01052856445, -974.77972412109),
            vector2(426.63781738281, -973.03894042969),
            vector2(440.31488037109, -973.03753662109),
            vector2(440.3251953125, -974.16259765625),
            vector2(441.84268188477, -974.69354248047),
            vector2(442.52615356445, -973.54748535156),
            vector2(459.7209777832, -973.03875732422),
            vector2(460.44540405273, -974.79345703125),
            vector2(461.95141601562, -974.76446533203),
            vector2(462.68081665039, -977.10650634766),
            vector2(463.79336547852, -977.3310546875),
            vector2(463.79656982422, -995.27642822266),
            vector2(462.4231262207, -995.01409912109),
            vector2(461.923828125, -998.02069091797),
            vector2(463.79705810547, -998.27893066406)
            },
            ['minZ'] = 24.7,  -- min height of the parking zone
            ['maxZ'] = 28.7,  -- max height of the parking zone
        },
        label = 'MRPD Garage',
        type = 'job',
        job = "police",
        ...
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(445.46, -997.14, 25.7, 268.61),
            vector4(445.74, -994.18, 25.7, 282.87),
            vector4(445.71, -991.75, 25.7, 303.72),
            vector4(445.44, -989.08, 25.7, 272.0),
            vector4(445.22, -985.99, 25.7, 276.74),
            vector4(437.26, -986.34, 25.7, 92.92),
            vector4(437.48, -988.93, 25.7, 103.29),
            vector4(437.8, -991.74, 25.7, 132.51),
            vector4(437.95, -994.24, 25.7, 92.85),
            vector4(438.07, -996.95, 25.7, 115.76),
            vector4(424.97, -997.24, 25.7, 292.85),
            vector4(424.7, -994.49, 25.7, 301.48),
            vector4(425.56, -991.44, 25.7, 270.28),
            vector4(425.07, -989.38, 25.7, 266.8),
            vector4(424.74, -984.36, 25.7, 268.92),
            vector4(425.27, -981.7, 25.7, 256.41),
            vector4(425.53, -978.7, 25.7, 264.8),
            vector4(425.36, -976.14, 25.7, 286.39),
        },
        debug = false
    },
    ['helipad'] = {
    ...
    ['aztecasgarage'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(-1154.3383789062, -1542.662109375),
            vector2(-1164.6955566406, -1549.9180908203),
            vector2(-1159.2926025391, -1557.7041015625),
            vector2(-1148.8237304688, -1551.0047607422)
            },
            ['minZ'] = 3.387225151062,  -- min height of the parking zone
            ['maxZ'] = 8.866352558136,  -- max height of the parking zone
        },
        label = 'Aztecas Garage',
        type = 'gang',
        gang = 'aztecas',
        vehicleCategories = {'car'},
        drawText = 'Aztecas Garage',
        showBlip = false,
        blipName = 'Hangar',
        blipNumber = 359,
        blipColor = 50,
    ...
    ['emsgarage'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(297.83108520508, -613.35235595703),
            vector2(283.73831176758, -608.39184570312),
            vector2(286.92041015625, -607.15081787109),
            vector2(289.20309448242, -605.28601074219),
            vector2(290.56393432617, -603.82098388672),
            vector2(292.27114868164, -598.53143310547),
            vector2(301.87872314453, -602.45556640625)
            },
            ['minZ'] = 41.26,  -- min height of the parking zone
            ['maxZ'] = 48.26,  -- max height of the parking zone
        },
        label = 'Ambulance Garage',
        type = 'job',
        job = 'ambulance',
        vehicleCategories = {'emergency'},
        drawText = 'Ambulance Garage',
        showBlip = false,
        blipName = 'Hangar',
        blipNumber = 359,
        blipColor = 50,
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(295.96, -610.9, 43.26, 93.93),
            vector4(297.2, -608.22, 43.27, 76.82),
            vector4(297.74, -605.01, 43.24, 66.51),
            vector4(298.57, -602.4, 43.21, 73.16) 
        },
    ...
    ['onealg'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(2481.3002929688, 4958.1342773438),
            vector2(2485.2543945312, 4954.072265625),
            vector2(2497.5534667969, 4966.4223632812),
            vector2(2493.6501464844, 4970.2646484375)
            },
            ['minZ'] = 44.0,  -- min height of the parking zone
            ['maxZ'] = 48.0,  -- max height of the parking zone
        },
        label = 'Oneal Garage',
        type = 'gang',
        gang = 'oneal',
        vehicleCategories = {'emergency'},
        drawText = 'Oneal Garage',
        showBlip = false,
        blipName = 'Hangar',
        blipNumber = 359,
        blipColor = 50,
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(2486.52, 4959.22, 44.85, 129.5),
            vector4(2489.1, 4962.08, 44.78, 144.68)
        },
