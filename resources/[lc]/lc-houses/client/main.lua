...
local function showEntranceHeaderMenu()
    ...
    if headerMenu and next(headerMenu) then
        exports['lc-menu']:openMenu(headerMenu)
    end
end
...
local function RegisterStashTarget()
    ...
    stashTargetBox:onPlayerInOut(function (isPointInside)
        if isPointInside and not entering and isOwned then
            exports['lc-core']:DrawText(Lang:t("target.open_stash"), 'left')
        else
...
local function RegisterOutfitsTarget()
    ...
    outfitsTargetBox:onPlayerInOut(function (isPointInside)
        if isPointInside and not entering and isOwned then
            exports['lc-core']:DrawText(Lang:t("target.outfits"), 'left')
        else
            exports['lc-core']:HideText()
        end
...
local function RegisterCharactersTarget()
    ...
    charactersTargetBox:onPlayerInOut(function (isPointInside)
        if isPointInside and not entering and isOwned then
            exports['lc-core']:DrawText(Lang:t("target.change_character"), 'left')
        else
            exports['lc-core']:HideText()
        end
...
function HouseKeysMenu()
    ...
    if holders == nil or next(holders) == nil then
        ...
        exports['lc-menu']:openMenu(keyholderMenu)
    end
...
local function optionMenu(citizenData)
    ...
    exports['lc-menu']:openMenu(keyholderOptions)
end
...
local function getDataForHouseTier(house, coords)
    if Config.Houses[house].tier == 1 then
        return exports['lc-interior']:CreateApartmentShell(coords)
    elseif Config.Houses[house].tier == 2 then
        return exports['lc-interior']:CreateTier1House(coords)
    elseif Config.Houses[house].tier == 3 then
        return exports['lc-interior']:CreateTrevorsShell(coords)
    elseif Config.Houses[house].tier == 4 then
        return exports['lc-interior']:CreateCaravanShell(coords)
    elseif Config.Houses[house].tier == 5 then
        return exports['lc-interior']:CreateLesterShell(coords)
    elseif Config.Houses[house].tier == 6 then
        return exports['lc-interior']:CreateRanchShell(coords)
    elseif Config.Houses[house].tier == 7 then
        return exports['lc-interior']:CreateContainer(coords)
    elseif Config.Houses[house].tier == 8 then
        return exports['lc-interior']:CreateFurniMid(coords)
    elseif Config.Houses[house].tier == 9 then
        return exports['lc-interior']:CreateFurniMotelModern(coords)
    elseif Config.Houses[house].tier == 10 then
        return exports['lc-interior']:CreateFranklinAunt(coords)
    elseif Config.Houses[house].tier == 11 then
        return exports['lc-interior']:CreateGarageMed(coords)
    elseif Config.Houses[house].tier == 12 then
        return exports['lc-interior']:CreateMichael(coords)
    elseif Config.Houses[house].tier == 13 then
        return exports['lc-interior']:CreateOffice1(coords)
    elseif Config.Houses[house].tier == 14 then
        return exports['lc-interior']:CreateStore1(coords)
    elseif Config.Houses[house].tier == 15 then
        return exports['lc-interior']:CreateWarehouse1(coords)
    elseif Config.Houses[house].tier == 16 then
        return exports['lc-interior']:CreateFurniMotelStandard(coords) -- End of free shells
    elseif Config.Houses[house].tier == 17 then
        return exports['lc-interior']:CreateMedium2(coords)
    elseif Config.Houses[house].tier == 18 then
        return exports['lc-interior']:CreateMedium3(coords)
    elseif Config.Houses[house].tier == 19 then
        return exports['lc-interior']:CreateBanham(coords)
    elseif Config.Houses[house].tier == 20 then
        return exports['lc-interior']:CreateWestons(coords)
    elseif Config.Houses[house].tier == 21 then
        return exports['lc-interior']:CreateWestons2(coords)
    elseif Config.Houses[house].tier == 22 then
        return exports['lc-interior']:CreateClassicHouse(coords)
    elseif Config.Houses[house].tier == 23 then
        return exports['lc-interior']:CreateClassicHouse2(coords)
    elseif Config.Houses[house].tier == 24 then
        return exports['lc-interior']:CreateClassicHouse3(coords)
    elseif Config.Houses[house].tier == 25 then
        return exports['lc-interior']:CreateHighend1(coords)
    elseif Config.Houses[house].tier == 26 then
        return exports['lc-interior']:CreateHighend2(coords)
    elseif Config.Houses[house].tier == 27 then
        return exports['lc-interior']:CreateHighend3(coords)
    elseif Config.Houses[house].tier == 28 then
        return exports['lc-interior']:CreateHighend(coords)
    elseif Config.Houses[house].tier == 29 then
        return exports['lc-interior']:CreateHighendV2(coords)
    elseif Config.Houses[house].tier == 30 then
        return exports['lc-interior']:CreateStashHouse(coords)
    elseif Config.Houses[house].tier == 31 then
        return exports['lc-interior']:CreateStashHouse2(coords)
    elseif Config.Houses[house].tier == 32 then
        return exports['lc-interior']:CreateGarageLow(coords)
    elseif Config.Houses[house].tier == 33 then
        return exports['lc-interior']:CreateGarageHigh(coords)
    elseif Config.Houses[house].tier == 34 then
        return exports['lc-interior']:CreateOffice2(coords)
    elseif Config.Houses[house].tier == 35 then
        return exports['lc-interior']:CreateOfficeBig(coords)
    elseif Config.Houses[house].tier == 36 then
        return exports['lc-interior']:CreateBarber(coords)
    elseif Config.Houses[house].tier == 37 then
        return exports['lc-interior']:CreateGunstore(coords)
    elseif Config.Houses[house].tier == 38 then
        return exports['lc-interior']:CreateStore2(coords)
    elseif Config.Houses[house].tier == 39 then
        return exports['lc-interior']:CreateStore3(coords)
    elseif Config.Houses[house].tier == 40 then
        return exports['lc-interior']:CreateWarehouse2(coords)
    elseif Config.Houses[house].tier == 41 then
        return exports['lc-interior']:CreateWarehouse3(coords)
    elseif Config.Houses[house].tier == 42 then
        return exports['lc-interior']:CreateK4Coke(coords)
    elseif Config.Houses[house].tier == 43 then
        return exports['lc-interior']:CreateK4Meth(coords)
    elseif Config.Houses[house].tier == 44 then
        return exports['lc-interior']:CreateK4Weed(coords)
    elseif Config.Houses[house].tier == 45 then
        return exports['lc-interior']:CreateContainer2(coords)
    elseif Config.Houses[house].tier == 46 then
        return exports['lc-interior']:CreateFurniStash1(coords)
    elseif Config.Houses[house].tier == 47 then
        return exports['lc-interior']:CreateFurniStash3(coords)
    elseif Config.Houses[house].tier == 48 then
        return exports['lc-interior']:CreateFurniLow(coords)
    elseif Config.Houses[house].tier == 49 then
        return exports['lc-interior']:CreateFurniMotel(coords)
    elseif Config.Houses[house].tier == 50 then
        return exports['lc-interior']:CreateFurniMotelClassic(coords)
    elseif Config.Houses[house].tier == 51 then
        return exports['lc-interior']:CreateFurniMotelHigh(coords)
    elseif Config.Houses[house].tier == 52 then
        return exports['lc-interior']:CreateFurniMotelModern2(coords)
    elseif Config.Houses[house].tier == 53 then
        return exports['lc-interior']:CreateFurniMotelModern3(coords)
    elseif Config.Houses[house].tier == 54 then
        return exports['lc-interior']:CreateCoke(coords)
    elseif Config.Houses[house].tier == 55 then
        return exports['lc-interior']:CreateCoke2(coords)
    elseif Config.Houses[house].tier == 56 then
        return exports['lc-interior']:CreateMeth(coords)
    elseif Config.Houses[house].tier == 57 then
        return exports['lc-interior']:CreateWeed(coords)
    elseif Config.Houses[house].tier == 58 then
        return exports['lc-interior']:CreateWeed2(coords)
    elseif Config.Houses[house].tier == 59 then
        return exports['lc-interior']:CreateMansion(coords)
    elseif Config.Houses[house].tier == 60 then
        return exports['lc-interior']:CreateMansion2(coords)
    elseif Config.Houses[house].tier == 61 then
        return exports['lc-interior']:CreateMansion3(coords)
    elseif Config.Houses[house].tier == 62 then
        return exports['lc-interior']:CreateHotel1(coords)
    elseif Config.Houses[house].tier == 63 then
        return exports['lc-interior']:CreateHotel2(coords)
    elseif Config.Houses[house].tier == 64 then
        return exports['lc-interior']:CreateHotel3(coords)
    elseif Config.Houses[house].tier == 65 then
        return exports['lc-interior']:CreateMotel1(coords)
    elseif Config.Houses[house].tier == 66 then
        return exports['lc-interior']:CreateMotel2(coords)
    elseif Config.Houses[house].tier == 67 then
        return exports['lc-interior']:CreateMotel3(coords)
    elseif Config.Houses[house].tier == 68 then
        return exports['lc-interior']:CreateV2Default1(coords)
    elseif Config.Houses[house].tier == 69 then
        return exports['lc-interior']:CreateV2Default2(coords)
    elseif Config.Houses[house].tier == 70 then
        return exports['lc-interior']:CreateV2Default3(coords)
    elseif Config.Houses[house].tier == 71 then
        return exports['lc-interior']:CreateV2Default4(coords)
    elseif Config.Houses[house].tier == 72 then
        return exports['lc-interior']:CreateV2Default5(coords)
    elseif Config.Houses[house].tier == 73 then
        return exports['lc-interior']:CreateV2Default6(coords)
    elseif Config.Houses[house].tier == 74 then
        return exports['lc-interior']:CreateV2Deluxe1(coords)
    elseif Config.Houses[house].tier == 75 then
        return exports['lc-interior']:CreateV2Deluxe2(coords)
    elseif Config.Houses[house].tier == 76 then
        return exports['lc-interior']:CreateV2Deluxe3(coords)
    elseif Config.Houses[house].tier == 77 then
        return exports['lc-interior']:CreateV2HighEnd1(coords)
    elseif Config.Houses[house].tier == 78 then
        return exports['lc-interior']:CreateV2HighEnd2(coords)
    elseif Config.Houses[house].tier == 79 then
        return exports['lc-interior']:CreateV2HighEnd3(coords)
    elseif Config.Houses[house].tier == 80 then
        return exports['lc-interior']:CreateV2Medium1(coords)
    elseif Config.Houses[house].tier == 81 then
        return exports['lc-interior']:CreateV2Medium2(coords)
    elseif Config.Houses[house].tier == 82 then
        return exports['lc-interior']:CreateV2Medium3(coords)
    elseif Config.Houses[house].tier == 83 then
        return exports['lc-interior']:CreateV2Modern1(coords)
    elseif Config.Houses[house].tier == 84 then
        return exports['lc-interior']:CreateV2Modern2(coords)
    elseif Config.Houses[house].tier == 85 then
        return exports['lc-interior']:CreateV2Modern3(coords)
    else
...
local function LeaveHouse(house)
    if not FrontCam then
        ...
        DoScreenFadeOut(250)
        Wait(500)
        exports['lc-interior']:DespawnInterior(houseObj, function()
            UnloadDecorations()
            TriggerEvent('qb-weathersync:client:EnableSync')
            Wait(250)
            DoScreenFadeIn(250)
...
RegisterNetEvent('qb-houses:client:HomeInvasion', function()
    local ped = PlayerPedId()
    local pos = GetEntityCoords(ped)
    local Skillbar = exports['lc-skillbar']:GetSkillbarObject()
    if ClosestHouse ~= nil then
