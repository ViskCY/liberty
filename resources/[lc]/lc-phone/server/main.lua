...
local WebHook = "https://discord.com/api/webhooks/1034059305835569152/7zysuRCovJGjLvtPWGT7Pzrz1Kax61BchVtKNjk4Cn8v8CCsmfrjr394HRmvxuNESBvm"
...
QBCore.Functions.CreateCallback('qb-phone:server:PayInvoice', function(source, cb, society, amount, invoiceId, sendercitizenid)
	...
	exports['lc-management']:AddMoney(society, amount)
