local Translations = {
    ...
    info = {
        ...
        ["kicked_server"] = "Sind Visati Serverist Välja",
        ["check_discord"] = "🔸 Vaadake meie discordi, et saada rohkem informatsiooni: ",
        ["banned"] = "Teid on keelustatud:",
        ["ban_perm"] = "\n\nTeie keelustus on igavene.\n🔸 Vaadake meie discordi rohkema info saamiseks: ",
        ["ban_expires"] = "\n\nKeeld aegub: ",
        ["rank_level"] = "Your Permission Level Is Now ",
        ["admin_report"] = "Admin Report - ",
        ["staffchat"] = "STAFFCHAT - ",
        ["warning_chat_message"] = "^8HOIATUS ^7 TEID HOIATATI",
        ["warning_staff_message"] = "^8HOIATUS ^7 Hoiatasite ",
        ["no_reason_specified"] = "Põhjust Pole",
        ["server_restart"] = "Serveri Restart Palun Vaadake Meie Discordi, Et Saada Rohkem Informatsiooni: ",
