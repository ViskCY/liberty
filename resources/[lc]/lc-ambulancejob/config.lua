...
Config.BleedTickDamage = 2 -- The base damage that is multiplied by bleed level everytime a bleed tick occurs
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["duty"] = {
        [1] = vector3(312.1, -597.7, 43.28),
        [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        --[1] = vector4(298.03, -605.1, 43.24, 70.94),
    ...
    ["main"] = {
        [1] = vector3(327.14, -603.89, 43.28),
    },
    ["stash"] = {
        [1] = vector3(306.3, -601.73, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(313.89, -578.97, 44.2, 157.66), taken = false, model = 1631638868},
        [2] = {coords = vector4(309.44, -577.03, 44.2, 154.69), taken = false, model = 1631638868},
        [3] = {coords = vector4(307.69, -581.87, 44.2, 340.99), taken = false, model = 1631638868},
        [4] = {coords = vector4(311.01, -583.05, 44.2, 339.2), taken = false, model = 1631638868},
        [5] = {coords = vector4(314.59, -584.0, 44.2, 331.91), taken = false, model = 1631638868},
        [6] = {coords = vector4(317.8, -585.45, 44.2, 337.26), taken = false, model = -1631638868},
        [7] = {coords = vector4(322.68, -587.17, 44.2, 333.21), taken = false, model = -1631638868},
        [8] = {coords = vector4(324.29, -582.83, 44.2, 152.13), taken = false, model = -1631638868},
	--- paleto
	    [9] = {coords = vector4(-252.43, 6312.25, 32.34, 313.48), taken = false, model = 1631638868},
        [10] = {coords = vector4(-247.04, 6317.95, 32.34, 134.64), taken = false, model = 1631638868},
        [11] = {coords = vector4(-255.98, 6315.67, 32.34, 313.91), taken = false, model = 1631638868},
    },
    ["jailbeds"] = {
