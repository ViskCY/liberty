...
function closeMenu() {
  ...
  $.post('https://lc-hud/closeMenu');
}
function restartHud() {
  closeMenu()
  $.post('https://lc-hud/restartHud');
}
function resetStorage() {
  closeMenu()
  $.post('https://lc-hud/resetStorage');
}
function showOutMap() {
  $.post('https://lc-hud/showOutMap');
}
function showOutCompass() {
  $.post('https://lc-hud/showOutCompass');
}
function showFollowCompass() {
  $.post('https://lc-hud/showFollowCompass');
}
function openMenuSounds() {
  $.post('https://lc-hud/openMenuSounds');
}
function resetHudSounds() {
  $.post('https://lc-hud/resetHudSounds');
}
function checklistSounds() {
  $.post('https://lc-hud/checklistSounds');
}
function showMapNotif() {
  $.post('https://lc-hud/showMapNotif');
}
function showFuelAlert() {
  $.post('https://lc-hud/showFuelAlert');
}
function showCinematicNotif() {
  $.post('https://lc-hud/showCinematicNotif');
}
function dynamicHealth() {
  $.post('https://lc-hud/dynamicHealth');
}
function dynamicArmor() {
  $.post('https://lc-hud/dynamicArmor');
}
function dynamicHunger() {
  $.post('https://lc-hud/dynamicHunger');
}
function dynamicThirst() {
  $.post('https://lc-hud/dynamicThirst');
}
function dynamicStress() {
  $.post('https://lc-hud/dynamicStress');
}
function dynamicOxygen() {
  $.post('https://lc-hud/dynamicOxygen');
}
function dynamicEngine() {
  $.post('https://lc-hud/dynamicEngine');
}
function dynamicNitro() {
  $.post('https://lc-hud/dynamicNitro');
}
function ToggleMapShape() {
  $.post('https://lc-hud/ToggleMapShape');
}
function changeFPS() {
  $.post('https://lc-hud/changeFPS');
}
function ToggleMapBorders() {
  $.post('https://lc-hud/ToggleMapBorders');
}
function HideMap() {
  $.post('https://lc-hud/HideMap');
}
function changeCompassFPS() {
  $.post('https://lc-hud/changeCompassFPS');
}
function showCompassBase() {
  $.post('https://lc-hud/showCompassBase');
}
function showStreetsNames() {
  $.post('https://lc-hud/showStreetsNames');
}
function showPointerIndex() {
  $.post('https://lc-hud/showPointerIndex');
}
function showDegreesNum() {
  $.post('https://lc-hud/showDegreesNum');
}
function cinematicMode() {
  $.post('https://lc-hud/cinematicMode');
}
