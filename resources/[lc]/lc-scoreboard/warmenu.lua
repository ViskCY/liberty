...
local function drawButton(text, subText, color, txtcolor)
    local x = menus[currentMenu].x + menuWidth / 2
...
function WarMenu.Button(text, subText, txtcolor, color)
    ...
    if menus[currentMenu] then
        ...
        drawButton(text, subText, color, txtcolor)
...
function WarMenu.MenuButton(text, id, color, txtcolor)
    if menus[id] then
        if WarMenu.Button(text, nil, color, txtcolor) then
            setMenuVisible(currentMenu, false)
